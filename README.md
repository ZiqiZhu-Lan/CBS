...
**Custom Background Sound** te permite mezclar sonidos ambientales — como lluvia, viento, hoguera, pájaros u olas del mar — para crear tu entorno de audio perfecto. No requiere instalación; funciona directamente en el navegador.

Desarrollado con **React + TypeScript**, **Howler.js** para el audio y **Zustand** para la gestión del estado. Todos los archivos de audio provienen de fuentes con licencias abiertas (CC0 / CC-BY).

---

## Funcionalidades

- **Mezcla multipista** — Reproduce varios sonidos ambientales simultáneamente
- **Control de volumen independiente** — Ajusta cada sonido por separado
- **Temporizador** — Para automáticamente todos los sonidos tras 1–60 minutos
- **Modos predefinidos** — Estudio, Relajación, Sueño
- **Cuentas de usuario** — Regístrate e inicia sesión para guardar tus preferencias
- **Almacenamiento seguro** — Contraseñas con hash SHA256; datos en localStorage
- **Modo sin conexión** — Funciona tras la primera carga, sin necesidad de internet
...
| Estilos | CSS Modules |
| Iconos | React Icons |
| Almacenamiento | localStorage + SHA256 (Crypto-JS) |
...
Todos los archivos de audio provienen de [Freesound.org](https://freesound.org) bajo licencias CC0 o CC-BY.
...
Este proyecto está bajo la licencia [CC BY-NC-ND 3.0 ES](https://creativecommons.org/licenses/by-nc-nd/3.0/es/).
